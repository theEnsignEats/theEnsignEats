...
describe('AboutPage', () => {
  ...
  test('renders Our History section', () => {
      ...
      expect(screen.getByAltText('Founders of Ensign Eats')).toBeInTheDocument();
  });
  ...
  test('renders Our Team section', () => {
      ...
      expect(screen.getByAltText('Employee of the Month: Monty')).toBeInTheDocument();
  });
  ...
  test('renders Awards section', () => {
      ...
      expect(screen.getByAltText('Best Burger Award Seal')).toBeInTheDocument();
  });
  ...
  test('renders Best Dessert section', () => {
      ...
      expect(screen.getByAltText('Best Dessert Award Seal')).toBeInTheDocument();
  });
});