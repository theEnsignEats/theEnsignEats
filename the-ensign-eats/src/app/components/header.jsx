  ...
  render() {
    return (
      <header className="bg-teal-900 p-4 flex justify-center items-center relative text-white">
        ...
        <button
          className="md:hidden px-6 bg-purple-900 hover:text-yellow-300 hover:shadow-md hover:shadow-yellow-300 hover:border-yellow-300 p-2 text-lg cursor-pointer rounded-full shadow-lg border-gray-200 border absolute top-0 right-0 m-4 flex items-center"
...
>
  ...
  <line x1="4" y1="18" x2="20" y2="18" />
        ...
        {this.state.isMobileMenuOpen && (
          <div className="md:hidden absolute top-full right-0 px-2  rounded-lg bg-purple-900 border-gray-200 border shadow-md hover:shadow-yellow-300 mt-7 mr-4">
            ...
            <NavLinkMobile to="/menu" onClick={this.closeMenu}>Menu</NavLinkMobile>
            <NavLinkMobile to="/order" onClick={this.closeMenu}>Order</NavLinkMobile>
          </div>
        )}
      </header>
    );
